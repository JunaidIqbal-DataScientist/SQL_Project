...
-- Creating and inserting data into the users table --
...
-- Creating and inserting values in restaurants table --
...
-- Creating and inserting values into Food table --
...
-- Creating and inserting values into menu table -- 
...
-- Creating and inserting values into order table -- 
...
-- Creating and inserting values into delivery_partners table -- 
...
-- Creating and inserting values into order_details table -- 
...
WHERE
	MONTH(o.date) = 7 AND YEAR(o.date) = 2022
GROUP BY
	r.r_name
ORDER BY
	Total_Orders DESC
...
-- Question 4: What are the restaurants with monthly sales greater than x for? --
SELECT
	r. r_name,
...
JOIN 
	food ON od. f_id = food. f_id
JOIN 
	menu ON food .f_id = menu.f_id
WHERE 
	o.user_id = 1 AND o.date BETWEEN '2022-06-11' AND '2022-07-20';

-- Question 6: Find restaurant with max repeated customers? -- 
SELECT 
	r. r_name, 
    o. user_id, 
    COUNT(o. user_id) AS repeat_count
FROM 
	orders o
JOIN 
	restaurants r ON o.r_id = r.r_id
...
-- Question 7: What is the month over month revenue growth of Swiggy? --
SELECT 
	MONTH(date) AS 'month', 
    YEAR(date) AS 'year', 
...
-- Question 8: What is the customers favourite food? --
SELECT 
	u. name, f. f_name, COUNT(od .f_id) AS order_count
FROM 
	users u
JOIN 
	orders o ON u.user_id = o.user_id
...
-- Question 9: Find the most loyal customer for all restaurant? --
SELECT 
	r. r_name, u. name, COUNT(o.order_id) AS order_count
FROM 
	orders o
JOIN 
...
-- Question 10: What is the month-over-month revenue growth of a restaurant? --
SELECT 
	r. r_name, 
